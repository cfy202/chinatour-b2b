    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            ...
            <div class="pull-right option-left">
				...
				<div style=" text-align:right; margin-top:10px; width:215px; cursor:pointer;"><i id="exportButton" class="fa fa-download"></i></div>
            </div>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
					...
					<div class="block-flat">
						...
						<div class="tab-content" id="tbodyContent">
							[#list listStasticAccount as stastic]
								<div id="${stastic.deptId}" style="display:none";>
									<table id="dataTable2" class="table table-bordered dataTable no-footer" width="100%" cellspacing="0">
									<thead>
									<tr>
										<th width="5%">Office</th>
										<th width="7%">Beginning Value</th>
										<th width="7%">Jan.</th>
										<th width="7%">Feb.</th>
										<th width="7%">Mar.</th>
										<th width="7%">Apr.</th>
...
<script type="text/javascript">
	    	...
	    	$.ajax({
				...
				str+=" "+"style='display:none';>";
					str += '<table id="datatables" class="ompTable" width="100%" cellspacing="0">'+
				        ...
				        //默认有一个值被选中
   						 $(".tab-content").children("#"+$("#deptId").find("option:selected").val()).css({"display":"block"});
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
    	...
    	$("#yearChange option[value="+now+"]").attr("selected", "selected");
    });
    //默认有一个值被选中
    $(".tab-content").children("#"+$("#deptId").find("option:selected").val()).css({"display":"block"});
     $("#deptIdForExport").val($("#deptId").find("option:selected").val());
    ...
    function deptChange(){
    	...
    	$(".tab-content").children("#"+checkText).css({"display":"block"});
    	$(".tab-content").children().not("#"+checkText).css({"display":"none"});
    };
