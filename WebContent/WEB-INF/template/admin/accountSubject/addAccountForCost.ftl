				...
				<div class="col-md-12">
					...
					<div class="tab-container">
							<ul class="nav nav-tabs">
							  ...
							  <li class="active"><a href="javascript:;" onclick="javascript:window.location.href='addAccountForCost.jhtml'" data-toggle="tab">Expense&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
							</ul>
                     </div>
                     [#assign a=0?number]
						...
						<table>
							<tbody>
								[#list accountSubjectList as accountSubject]
									[#if accountSubject.level==1 && accountSubject.subjectType==2]
											<tr>
