				...
				<div class="col-md-12">
					...
					<div class="tab-container">
							<ul class="nav nav-tabs">
							  <li class="active"><a href="javascript:;" onclick="javascript:window.location.href='addAccountForSalesIncome.jhtml'" data-toggle="tab">Sales Income</a></li>
							...
							<table>
								<tbody>
									[#list accountSubjectList as accountSubject]
										[#if accountSubject.level==1 && accountSubject.subjectType==3]
												<tr>
