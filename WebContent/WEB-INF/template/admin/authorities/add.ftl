            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block-flat">
                        ...
                        <div class="content">
                            <form class="form-horizontal group-border-dashed" action="[@spring.url '/admin/roles/save.jhtml'/]" style="border-radius: 0px;" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="description" class="form-control" required parsley-maxlength="6" placeholder="Max 6 chars." />
									</div>
								</div>
								<!--
								<div class="form-group">
	                                ...
	                                <div class="col-sm-6">
                                       	<div class="radio">
                                            <label>
                                            	<input type="checkbox" name="isSystem" value="true" class="icheck"/>是否内置
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-6">
	                                    <div class="radio">
	                                    	<label><input type="checkbox" name="authority" value="admin:enquirys" class="icheck"/>Inquiries(Agent)</label>
	                                    </div>
	                                    <div class="radio">
	                                    	<label><input type="checkbox" name="authority" value="admin:enquirysDraft" class="icheck"/>Draft(Agent)</label>
	                                    </div>
	                                    <div class="radio">
	                                    	<label><input type="checkbox" name="authority" value="admin:enquirysOp" class="icheck"/>Inquiry List(OP)</label>
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="form-group">
