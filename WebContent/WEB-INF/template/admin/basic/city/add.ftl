        ...
        <div class="block-flat">
          ...
          <div class="content">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="cityName" class="form-control" required parsley-maxlength="6" placeholder="Max 6 chars." />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Code</label>
                <div class="col-sm-6">
                  <input type="text" name="cityCode" class="form-control" required parsley-maxlength="6" placeholder="Max 6 chars." />
                </div>
              </div>
              <div class="form-group">
