									...
									<div  class="nav-block">
										...
										<div  class="block-body default-2-line">
											<div  class="params-cont">
												<input type="text" size="14" id="search_currencyChs"  placeholder="Search currencyChs..." />
											</div>
										</div>
									</div>
								</div>
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/currencyType/list.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
					data.currencyChs = $("#search_currencyChs").val();
				}
            },
            "columns": [
