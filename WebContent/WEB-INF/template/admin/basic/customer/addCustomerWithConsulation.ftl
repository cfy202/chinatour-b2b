        ...
        <div class="block-flat" style="height:600px;">
          <div class="tab-container">
			<ul class="nav nav-tabs">
			  ...
			  <li class="active"><a href="#profile">Consultation Info</a></li>
			</ul>
				<div class="tab-content">
				 <div class="tab-pane active cont" id="profile">
					...
					<form action="" method="post" id="customerConsulationForm">
						...
						<div style="width:30%;float:right;border:1px solid #ccc;height:420px;background-color:#fce6d4;">
							<div class="form-group" style="margin-left:18px;">
				              <label>ConsultMethod</label> <input type="text" id="consultMethod" name="consultMethod" class="form-control"   style="width:89%;"/>
				            </div>
				            <div class="form-group" style="margin-left:18px;">
				              <p>ConsultContent</p>
				              <textarea rows="8" cols="30" name="consultContent" id="consultContent"></textarea>
				            </div>
				            <div class="form-group" style="margin-left:18px;">
