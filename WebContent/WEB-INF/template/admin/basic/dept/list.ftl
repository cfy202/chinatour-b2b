...
<script type="text/javascript">
     $(document).ready(function () {
        ...
        {	
            ...
            sOut += '<tr><td>Fax:</td><td>'+aData.fax+'</td></tr>';
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/dept/list.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
           ...
           "columns": [
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					return '<div class="btn-group"><button class="btn btn-default btn-xs" type="button">Action</button><button data-toggle="dropdown" class="btn btn-xs btn-primary dropdown-toggle" type="button"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul role="menu" class="dropdown-menu pull-right"><li><a href="${base}/admin/dept/edit?id='+data+'"><i class="fa fa-pencil"></i>Edit</a></li><li><a href="${base}/admin/dept/editTourTypeOfDept?id='+data+'"><i class="fa fa-pencil"></i>Tour Type</a></li><li class="divider"></li><li><a data-href="${base}/admin/dept/del?id='+data+'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i>Delete</a></li></ul></div>';
                 },
				"targets" : 5
		   }],
		   "order": [[ 1, 'asc' ]],
