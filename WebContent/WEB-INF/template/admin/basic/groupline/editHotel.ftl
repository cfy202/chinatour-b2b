	...
	<div class="row">
      <div class="col-md-12">
        ...
        <div class="block-flat">
          ...
          <div class="content">
            <form class="form-horizontal group-border-dashed" action="updateHotel.jhtml" method="post" parsley-validate novalidate>
              <input type="hidden" name="groupLineId" class="form-control" value="${hotel.groupLineId}" />
              <input type="hidden" name="groupLineHotelRelId" class="form-control" value="${hotel.groupLineHotelRelId}" />
              <input type="hidden" name="id" class="form-control" value="${hotel.id}" />
              <div class="form-group">
                <label class="col-sm-3 control-label">DayNum</label>
                <div class="col-sm-6">
                  <select type="text" name="dayNum" class="select2">
                    [#list 1..30 as dayNum]
                        <option value="${dayNum}" [#if "${dayNum==hotel.dayNum}"] selected="selected" [/#if]>The ${dayNum} Day</option>
                    [/#list]
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="tel" class="form-control" value="${hotel.tel}"/>
                </div>
              </div>              
              <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
       App.init();
       $("select[name='standard']").val('${hotel.standard}'); 
    });
</script>
</body>
</html>
