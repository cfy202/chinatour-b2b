								    ...
								    <div  class="nav-block">
								      ...
								      <div  class="block-body default-2-line">
								        <div  class="params-cont"> 
								            ...
								            <input type="text" size="14" id="search_tourName" placeholder="TourName..." />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/groupline/listForOp.jhtml'/]",
                type: "POST",
                "data": function ( d ) {
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					html='<div class="btn-group"><button class="btn btn-default btn-xs" type="button">Action</button><button data-toggle="dropdown" class="btn btn-xs btn-default dropdown-toggle" type="button"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul role="menu" class="dropdown-menu pull-right">'
						+'<li><a href="editforAdmin.jhtml?id='+data+'"><i class="fa fa-pencil"></i>Edit</a></li>';
						if((row.isSystem+"").indexOf("2")!=-1){
							html+='<li><a href="addTime.jhtml?groupLineId='+data+'"><i class="fa fa-pencil"></i>Add Date</a></li>'
						}
						html+='<li><a href="setGroupRoute.jhtml?groupLineId='+data+'"><i class="fa fa-pencil"></i>Itinerary</a></li>'
						html+='<li><a href="setHotel.jhtml?groupLineId='+data+'"><i class="fa fa-pencil"></i>Hotel</a></li>'
						html+='<li><a href="toFdf.jhtml?groupLineId='+data+'"><i class="fa fa-eye"  data-toggle="modal" data-modal="form-primary" ></i>View</a></li>'
						html+='<li><a data-href="del.jhtml?id='+data+'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i>Delete</a></li></ul></div>';
					return html;
                 },
				"targets" : 5
		  	}],
