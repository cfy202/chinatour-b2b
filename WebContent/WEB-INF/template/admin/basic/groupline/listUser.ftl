...
<!-- /.modal -->
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2>Product</h2>
            <div class="new">
            	<button class="btn btn-success" type="button" id="New" onclick="location.href='add.jhtml'">&nbsp;&nbsp;New &nbsp;&nbsp;</button>
            </div>
            <!--[#if size!=0]
            <div class="new">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        {	
            ...
            var aData = oTable.fnGetData(nTr);
            var tourNo = aData.tourNo;
            var aData = oTable.fnGetData(nTr);
            var tourType = aData.tourType;
            ...
            sOut += '<tr><td style="border-bottom: 1px solid #dadada;width:10%;">Tour No:</td><td style="border-bottom: 1px solid #dadada;">'+tourNo+'</td></tr>';
            sOut += '<tr><td style="border-bottom: 1px solid #dadada;width:10%;">Product Type:</td><td style="border-bottom: 1px solid #dadada;">'+tourType+'</td></tr>';
