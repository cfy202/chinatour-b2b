...
<!-- /.modal -->
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2>Product</h2>
            <div class="new"><button class="btn btn-success" type="button" id="New" onclick="location.href='addPeerProduct.jhtml'">&nbsp;&nbsp;New &nbsp;&nbsp;</button></div>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/groupline/agencyList.jhtml'/]",
                type: "POST",
                "data": function ( d ) {
            ...
            "columns": [
                ...
                { "data": "tourCode",
                	"render":function(data,type,row){
                		if(row.least==100){
                			return data+'<i class="fa fa-info-circle" title="New Product,No Have Price"></i>'
                		}else{
                			return ''+data+''
                		}
                	}
