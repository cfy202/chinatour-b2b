          ...
          <div class="content">
            <form class="form-horizontal group-border-dashed" id="formId" action="save.jhtml" method="post"> 
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="hotelName" class="form-control" required parsley-maxlength="6" placeholder="Max 6 chars." />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="address" class="form-control"  parsley-maxlength="6" placeholder="Max 6 chars." />
                </div>
              </div> 
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="tel" class="form-control"  parsley-maxlength="36" placeholder="Max 36 chars." />
                </div>
              </div> 
              <div class="form-group">
