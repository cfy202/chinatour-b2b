									...
									<div  class="nav-block">
										...
										<div  class="block-body default-2-line">
											<div  class="params-cont"> 
												<input type="text" size="14" id="search_hotelName"  placeholder="Search hotelName..." />
												<input type="text" size="14" id="search_standard" placeholder="Search standard..." />
												<input type="text" size="14" id="search_address" placeholder="Search address..." />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/hotel/list.jhtml'/]",
                type: "POST",
				"data": function ( data ) {
					data.hotelName = $("#search_hotelName").val();
					data.standard = $("#search_standard").val();
					data.address = $("#search_address").val();
