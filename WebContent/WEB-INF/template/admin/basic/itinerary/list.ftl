...
<script type="text/javascript">
     $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/itinerary/list.jhtml'/]",
                type: "POST",
				"data": function ( d ) {
           ...
           "columns": [
                { "data": "itineraryInfoId","visible":false },
                { "data": "tourCode" },
                { "data": "tourName" },
                { "data": "itineraryInfoId" }
            ],
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					return '<div class="btn-group"><button class="btn btn-default btn-xs" type="button">Action</button><button data-toggle="dropdown" class="btn btn-xs btn-primary dropdown-toggle" type="button"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul role="menu" class="dropdown-menu pull-right"><li><a href="${base}/admin/itinerary/edit?id='+data+'"><i class="fa fa-pencil"></i> Edit</a></li><li><a href="${base}/admin/itinerary/preview?id='+data+'"><i class="fa fa-eye"></i> View</a></li><li class="divider"></li><li><a data-href="${base}/admin/itinerary/del?id='+data+'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i> Delete</a></li></ul></div>';
                 },
				"targets" : 3
		  }]
