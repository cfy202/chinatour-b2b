									...
									<div  class="nav-block">
										...
										<div  class="block-body default-2-line">
											<div  class="params-cont">
												<input type="text" size="14" id="search_stateName"  placeholder="Search stateName..." />
												<input type="text" size="14" id="search_countryName"  placeholder="Search countryName..." />
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/state/list.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
					data.stateName = $("#search_stateName").val();
				}
            },
