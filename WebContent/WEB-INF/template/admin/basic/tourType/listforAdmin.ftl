...
[#include "/admin/include/sidebar.ftl"]
    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2>Tour Type</h2>
            <div class="new"><button class="btn btn-success" type="button" id="New" onclick="location.href='addforAdmin.jhtml'">&nbsp;&nbsp;New &nbsp;&nbsp;</button></div>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
