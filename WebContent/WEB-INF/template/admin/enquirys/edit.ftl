				...
				<div class="col-md-12 fuelux">
					<div class="block-wizard">
						<div class="step-content">
							<form class="form-horizontal group-border-dashed" action="update.jhtml?temp=${enquirys.type}" method="post"
									...
									<table style="padding:10px;border: 0px none" width="100%">
										<tbody>
											<tr>
												...
												<td width="37%">
													<input type="text" name="firstName" value="${enquirys.firstName}" class="form-control input-group1 peer" required placeholder="First Name">
												</td>
												<td width="13%">
													<span>
														LastName:
												...
												<td width="37%">
													<input type="text" name="lastName"  value="${enquirys.lastName}" class="form-control input-group1 peer" required placeholder="Last Name">
												</td>
											</tr>
											<tr>
												<td width="13%">
												...
												<td width="37%">
													<input type="text" name="contactPhone" value="${enquirys.contactPhone}" class="form-control input-group1 peer" placeholder="Phone">
												</td>
												<td width="13%">
													<span>
														Email：
												...
												<td width="37%">
													<input type="email" name="email" value="${enquirys.email}" class="form-control input-group1 peer" parsley-type="email" placeholder="Enter a valid e-mail">
												</td>
											</tr>
											<tr>
												<td width="13%">
												...
												<td width="37%">
													<input type="text" name="hotelStandard" value="${enquirys.hotelStandard}" class="form-control input-group1 peer" placeholder="Hotel">
												</td>
											</tr>
											<tr>
												<td width="13%">
												...
												<td width="37%">
													<select id="selectBrandId" class=" select2 peer" name="brand">
														[#list constant.BRAND_ITEMS as val]
															<option value="${val}" [#if enquirys.brand == val] selected="selected" [/#if]>${val}</option>
														[/#list]
													</select>
												</td>
												<td width="13%">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//默认选中
		$("#selectTypeId").select2("val","${enquirys.tourTypeId}");
	});
	//bran 级联选中
