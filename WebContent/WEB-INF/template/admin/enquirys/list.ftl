...
<script type="text/javascript">
     $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/enquirys/list.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
				...
				"render" : function(data, type, row) {
					 html='<div class="btn-group">'
								...
								+'<ul role="menu" class="dropdown-menu pull-right">'
									+'<li><a href="${base}/admin/enquirys/edit?temp=0&id='+data+'"><i class="fa fa-pencil"></i>Edit</a></li>'
									+'<li><a href="${base}/admin/enquirys/searchDetail?temp=0&id='+data+'"><i class="fa fa-search"></i>View</a></li>'
									+'<li class="divider"></li>';
								if(row.enState==1){
									html+='<li><a href="'+row.serverIp+'${base}/admin/enquirys/download?id='+data+'" ><i class="fa fa-download"></i>Download</a></li>';
								}else{
									html+='<li>&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i>Download</a>';
								}
									html+='<li><a data-href="${base}/admin/enquirys/del?id='+data+'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i>Delete</a></li>'
								+'</ul>'
							+'</div>';
				return html;
                 },
