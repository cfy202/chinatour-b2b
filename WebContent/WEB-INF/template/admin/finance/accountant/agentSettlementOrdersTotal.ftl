...
<div class="container-fluid" id="pcont">
	<div class="page-head">
		...
		<div class="pull-right">
			...
			[#if tour.allCheck!=2&&ordersTotal.tax==0]
				<button id="agentCheckId" class="btn btn-primary" type="button"  onclick="agentUpdateOrderTotalTaxState();">&nbsp;&nbsp;Settling&nbsp;&nbsp;</button>
			[/#if]
			[#if tour.allCheck!=2]
			...
			<div class="col-md-12">
				<div class="block-flat">
					<div class="header text-center">
						<h3 class="filter-bar">${ordersTotal.orderNumber}-Bill</h3>
