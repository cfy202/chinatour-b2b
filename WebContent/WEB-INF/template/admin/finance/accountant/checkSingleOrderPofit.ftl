...
<div class="container-fluid" id="pcont">
	<div class="page-head">
		...
		<div class="pull-right" id="contentId" >[#if supplierPrice.accCheck==1&&supplierPrice.allCheck==1]<button id="agentCheckId" class="btn btn-primary" type="button"  onclick="submitForm();">&nbsp;&nbsp;申请结算&nbsp;&nbsp;</button>[/#if]<button id="checkId" class="btn btn-primary" type="button"  onclick="submitForm();">&nbsp;&nbsp;结算&nbsp;&nbsp;</button><button class="btn btn-primary" type="button" id="New" onclick="submitForm();">&nbsp;&nbsp;结算变更单&nbsp;&nbsp;</button> </div>
		<ol class="breadcrumb">
			<li><a href="#">Home</a></li>
			<li><a href="#">Bill</a></li>
		</ol>
			...
			<div class="col-md-12">
				<div class="block-flat">
					<div class="header text-center">
						<h3 class="filter-bar"> Tour Settlement Bill</h3>
