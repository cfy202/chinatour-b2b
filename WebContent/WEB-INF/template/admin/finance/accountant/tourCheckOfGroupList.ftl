				...
				<div class="col-md-12">
					<div class="tab-container">
							<ul class="nav nav-tabs">
							  <li  class="active"><a href="javascript:;" onclick="javascript:window.location.href='groupTourList.jhtml'" data-toggle="tab">Common Tour</a></li>
							  <li><a href="javascript:;" onclick="javascript:window.location.href='approveForGroup.jhtml'" data-toggle="tab">Europe Tour&nbsp;&nbsp;&nbsp;<span class="bubble">0</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
							</ul>
                        </div>
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/groupTourList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
