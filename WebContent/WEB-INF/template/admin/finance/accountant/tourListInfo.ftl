...
<!-- /.modal -->
    <div class="container-fluid" id="pcont">
        <div class="page-head">
             ...
             <div class="new"><a href='javascript:chbox();' class="btn btn-success" >Audit</a><a class="btn pull-right " href="javascript:explorBill();" title="Export Bill"><i class="fa fa-share-square-o" ></i></a></div>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                ...
                <div class="col-md-12">
                    <div class="block-flat">
                       <div class="header">
                        ...
                        <div class="content">
                        	<form method="post" id="formId" action="[@spring.url '/admin/supplierPrice/accCheckAll.jhtml'/]">
	                            <div class="table-responsive">
	                                <table class="table table-bordered" id="datatable2">
	                                    ...
	                                    <tr>
											...
											<th>Arriva lDate</th>
											<th>Total Pax</th>
											<th><input id="check-all" type="checkbox" name="checkall"/>Accountant Auditing</th>
											<th>Status</th>
											<th>Invoice</th>
...
<script type="text/javascript">
     ...
     $('input').iCheck({
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/accountantTourList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
            ...
            "columns": [
                ...
                { "data": "accCheck" ,
                	"render": function (data, type, row) {
                		var html="recording";
                		if(data==0){
                			html="<div class='radio'><input type='checkbox'  name='tourIds' value='"+row.tourId+"' class='icheck'/>New</div>";
                		}else if(data==1){
                			html="Approved";
                		}else if(data==2){
                			html="Disapproved";
		    ...
		    "fnCreatedRow": function( nRow, aData, iDataIndex ) {
		    	var str='<div>';
		    	if(aData.fileUrl!=null&&aData.fileUrl.length>0){
		    		str+='<a href="${base}/admin/supplierPrice/downloadTourFile?id='+aData.supplierPriceId+'" ><i class="fa fa-download"></i></a>';
		    	}else{
	...
	function explorBill(){
		...
		var arriveDateTime=$("#arriveDateTimeId").val();
		var beginningDate = $("#search_beginningDate").val();
		var endingDate = $("#search_endingDate").val();
		location.href="${base}/admin/payCostRecords/explorBill.jhtml?userName="+userName+"&beginningDate="+beginningDate+"&endingDate="+endingDate;
	}
	    //全选或不全选
	...
	function initAddHtml($addHtml){
		...
		return $addHtml;
     	...
     	//批量审核 提交表单
	function chbox(){
		var length = $("input[name='tourIds']:checked").size();
		if(length == 0){
			alert("Select Tour");
			return;
		}
