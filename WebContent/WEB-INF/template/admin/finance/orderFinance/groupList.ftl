            ...
            <div class="row">
    			...
    			<div class="tab-container">
						<ul class="nav nav-tabs">
						  <li class="active"><a href="javascript:void(0);" onclick="local('groupList.jhtml')" data-toggle="tab">Income</a></li>
						  <li><a href="javascript:void(0);" onclick="local('groupPayList.jhtml')" data-toggle="tab">Cost</a></li>
						</ul>
				                    	...
				                    	<table class="table table-bordered" id="datatable2">
				                        	<thead>
				                            	<tr>
													...
													<th><input id="check-all" type="checkbox" name="checkall" />Auditing Status</th>
													<th>Action</th>
												</tr>
				                           	</thead>
				                        </table>
     ...
     $(document).ready(function () {
      ...
      $('input').iCheck({
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/payCostRecords/groupList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
