...
[#include "/admin/include/sidebar.ftl"]
    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2>Booking Cost</h2>
            <div class="new"><button class="btn btn-success" type="button" onclick="chbox();" data-toggle="modal">&nbsp;&nbsp;Bunk Audit &nbsp;&nbsp;</button></div>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
    			...
    			<div class="col-md-12">
					...
					<div class="tab-container">
						<ul class="nav nav-tabs">
							<li><a href="javascript:void(0);" onclick="local('groupList.jhtml')" data-toggle="tab">Income</a></li>
							<li class="active"><a href="javascript:void(0);" onclick="local('groupPayList.jhtml')" data-toggle="tab">Cost</a></li>
						</ul>
												...
												<div  class="nav-block">
													...
													<div  class="block-body default-2-line">
														<div  class="params-cont"> 
															...
															<input type="text" size="14" id="search_vender" placeholder="Supplier" />
														</div>
													</div>
												</div>
											</div>
				                    	...
				                    	<table class="table table-bordered" id="datatable2">
				                        	<thead>
				                            	<tr>
													...
													<th>Due Time</th>
													<th>Amount</th>
													<th><input id="check-all" type="checkbox" name="checkall" />Acc. Status</th>
			...
			<div class="modal-body form">
				<div class="row no-margin-y">
					<div class="form-group col-md-6 col-sm-6  col-xs-6 no-margin">
						Payment:<input type="name" class="form-control"  id="itemId">
					</div>
					<div class="form-group col-md-6 col-sm-6  col-xs-6 no-margin">
						Description:<input type="name" name="remark" class="form-control" id="remarkId">
					</div>
				</div>
				<div class="row no-margin-y">
					<div class="form-group col-md-6 col-sm-6  col-xs-6 no-margin">
				...
				<div class="text-center">
					...
					<div class="text-center"id="centerId">
						...
						<input type="hidden" value="512" name="munId"/>
     ...
     $(document).ready(function () {
      ...
      $('input').iCheck({
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "bSort":false,
            "ajax": {
                url: "[@spring.url '/admin/payCostRecords/groupPayList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
           ...
           "columns": [
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					var html;
					if(row.status==0){
						html='<a href="javascript:confirmUp(\''+data+'\');"><i class="fa fa-pencil"></i>Approve</a>';
					}else{
						html='<i class="fa fa-pencil"></i>Approve';
					}
					return html;
                 },
				"targets" : 10
		  ...
		  "fnCreatedRow": function( nRow, aData, iDataIndex ) {
		 		 $('td:eq(0)', nRow).html( '<img class="toggle-details" src="[@spring.url '/resources/images/plus.png'/]" />' ); 
		  		  var str='';
                 		if(aData.status==0){
                 			str+='<div class="radio"><input type="checkbox"  name="records" value="'+aData.id+'" class="icheck"/><i class="fa fa-eye"></i></div>';
                 		}else{
                 			str+='<input type="checkbox"  name="records" value="'+aData.id+'" class="icheck" disabled="disabled"/><i class="fa fa-check"></i>';
                 		}
