    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            ...
            <div class="new" style="width:300px">
            	...
            	<!--<a class="btn btn-primary"  onclick="intuit.ipp.anywhere.controller.onConnectToIntuitClicked();">Content</a>-->
...
<script type="text/javascript">
	...
	intuit.ipp.anywhere.setup({
            grantUrl: 'http://localhost:8080/chinatour-3.0/admin/oauth/request_token.jhtml?companyId=123145810214857',
            datasources: {
                 quickbooks : true,
                 payments : false
           }
