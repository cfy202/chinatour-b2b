						...
						<form id="dataForm" class="form-horizontal group-border-dashed" novalidate="" action="${base}/admin/notice/save.jhtml" method="post">
							...
							<div class="form-group" style="padding:10px 0;">
				                ...
				                <div class="col-sm-6 col-sm-6S">
				                  <select name="receiveUserS" class="select2" multiple="multiple">
				            ...
				            <div class="form-group" style="padding:10px 0;">
				                ...
				                <div class="col-sm-6 col-sm-6S">
				                  <select name="receiveUserC" class="select2" multiple="multiple">
				                     [#list adminList as admin]
				                        <option value="${admin.id}">${admin.username}&nbsp;——&nbsp;${admin.deptName}</option>
				                    [/#list]
				                  </select>
				            ...
				            <div class="form-group" style="padding:10px 0;">
				                ...
				                <div class="col-sm-6 col-sm-6S">
				                   <input class="form-control" name="notice.title" type="text">
				            	</div>
				            </div>
			            	<div>
				            ...
				            <div class="form-group">
								<textarea name="notice.content" class="ckeditor form-control"></textarea>
							</div>
	          				<div class="form-group">
								<div class="col-sm-12">
