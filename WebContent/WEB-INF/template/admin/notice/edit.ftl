					...
					<div class="content1">
						<form id="dataForm" class="form-horizontal group-border-dashed" novalidate="" action="${base}/admin/notice/save.jhtml" method="post">
				                  ...
				                  <select name="receiveUserS" class="select2" multiple="multiple" size="25">
				                     [#list adminList as admin]
				                     	...
				                     	[#list receiverList as receiver]
							      			[#if admin.id==receiver.receiveUser] selected="selected"[/#if]
							      		[/#list]
							      		>${admin.username}&nbsp;——&nbsp;${admin.deptName}</option>
				                     [/#list]
				                  </select>
				            	</div>
				            </div>
				            ...
				            <div class="form-group" style="padding:10px 0;">
				                ...
				                <div class="col-sm-6 col-sm-6S">
				                   <input class="form-control" name="notice.title" value="${noticeContact.notice.title}" type="text">
				            	</div>
				            </div>
			            	<div>
				            	...
				            	<div>
				            		<div id="fileName" style="float:left;" >
					            		 [#list AppendixList as appendix]
					            			 ...
					            			 <a href="javascript:void(0);" >${appendix.appendixName}</a><a href="javascript:remPath('fileName${appendix_index}');" class="label label-danger"><i class="fa fa-times"></i></a>
					            			 <div style="display: none"><input  name="appendixFile['${appendix.appendixFile}']" type="text" value="${appendix.appendixName}"></div>
					            			 </span>
				            			 [/#list]
				            		</div>
				            		<div class="progress progress-striped active" id="progress-striped" style="display: none">
