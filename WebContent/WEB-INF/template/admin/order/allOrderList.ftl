						...
						<div class="header">
							...
							<div class="options" style="margin:10px; padding:5px 0;">
								<div class="nav-panel">
									...
									<div class="nav-block">
										<div class="block-head">
											<span class="nav-title">Bookin Date</span>:
										</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/orders/findAllOrderList.jhtml'/]",
                type: "POST",
                "data": function ( d ) {
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					...
					+'<li><a href="edit.jhtml?menuId=304&ordersTotalId='+data+'"><i class="fa fa-pencil"></i>Edit</a></li>'
