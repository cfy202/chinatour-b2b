    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <h4><i class="fa fa-warning"></i> Warning !</h4>
                    <p>Are You Sure Client Info. Recoverd ？</p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        {	
            ...
            sOut += '<tr><td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">Language:</td><td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">';
                ...
                { "data": "isDel", 
                  "render": function (data, type, row) {
                  	  if(data == 0){
                  	  	...
                  	  	return "<span class='color-danger'>Canceled</span>";
                  	  }else{
                  	  	return "<span class='color-warning'>Cancelling</span>";
                  	  }
                   }	
                }, 
                { "data": "customerTourNo" },
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					if(row.isDel == 0){
						...
						+'<li><a style="cursor:pointer;" data-href="cancelCustomer.jhtml?customerId='+data+'&orderId=${orderId}" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i>Cancell Guest</a>'
						+'</li></ul></div>';
					}
					return '<div class="btn-group"><button class="btn btn-default btn-xs" type="button">Action</button>'
					+'<button data-toggle="dropdown" class="btn btn-xs btn-primary dropdown-toggle" type="button"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>'
					+'<ul role="menu" class="dropdown-menu pull-right">'
					+'<li><a style="cursor:pointer;" data-href="recoverCustomer.jhtml?customerId='+data+'&orderId=${orderId}" data-toggle="modal" data-target="#confirm-recover"><i class="fa fa-reply-all"></i>Recoverd Guest</a>'
					+'</li></ul></div>';
                 },
				"targets" : 13
			}],
