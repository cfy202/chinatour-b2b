...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/orders/groupList.jhtml'/]",
                type: "POST",
                "data": function ( d ) {
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					var condition = '<li><a data-href="del.jhtml?id='+data+'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i>Delete</a></li>';
					...
					+'<li><a href="edit.jhtml?menuId=307&ordersTotalId='+data+'"><i class="fa fa-pencil"></i>Edit</a></li>'
