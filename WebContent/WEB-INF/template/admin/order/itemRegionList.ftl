							...
							<div class="options" style="margin:10px; padding:5px 0;">
									...
									<!--	<div  class="nav-block">
										...
										<div  class="nav-block">
											...
											<div  class="block-body default-4-line">
												<div  class="params-cont"> 
													<select class="select2" id="brandId"  onchange="tourTypeSelect(this);" >
														<option value="0">Select Brand</option>
														<option value="中国美">中国美</option>
														<option value="文景假期">文景假期</option>
														<option value="inbound">inbound</option>
														<option value="chinatour">chinatour</option>
														<option value="InterTrips">InterTrips</option>
													</select>
												</div>
											</div>
										</div>
										<div  class="nav-block">
											<div  class="block-head">
												<span  class="nav-title">Tour Type</span>:
											</div>
											<div  class="block-body default-4-line">
												<div  class="params-cont"> 
													<select class="select2" id="tourTypeId">
										...
										<div  class="nav-block">
											...
											<div  class="block-body default-2-line">
												<div  class="params-cont"> 
													...
													<input type="text" size="14" id="search_tourCode" placeholder="Tour Code..." />
													<input type="text" size="14" id="search_userName" placeholder="Agent..." />
													<input type="text" size="14" id="search_peer" placeholder="Peer..." />
													<input type="text" size="14" id="search_office" placeholder="Office..." />
													<input type="text" size="14" id="search_source" placeholder="Vender..." />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".params-cont select.select2").select2({
        	width: '150px'
        });
        ...
        {	
            ...
            sOut += '<tr><td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">Peer:: '+aData.peerId+'</td><td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">Total Amount : '+aData.commonTourFee+'</td></tr>';
        	...
        	sOut += '<tr><td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">Tour Type : '+aData.tourTypeName+'</td>';
            sOut += '<td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">Product Vender:'+aData.source+'</td></tr>';
            sOut += '<tr><td style="border-left: 1px solid #DADADA;border-bottom: 1px solid #dadada;">Web Order No.:'+aData.refNo+'</td>';
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/orders/itemRegionList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					if(row.isSelfOrganize!=1){
						return '<i class="fa fa-eye"></i><a style="cursor:pointer;" href="findOrderInfo.jhtml?menuId=309&id='+data+'">view</a>'
					}else{
						return '';
					}
                 },
	...
	/* 根据brand动态加载tourType  */
    function tourTypeSelect(brandSelect) {
        var $tourTypeId = $("#tourTypeId");
        var brand = $(brandSelect).val();

        $tourTypeId.children("option").remove();
        $tourTypeId.append("<option value='0'>Select Type</option>");
        $tourTypeId.val("0");
        if (brand != '0') {
            $.post("findTourTypeName.jhtml", {
                "brand": brand
            },
            function(result) {
                $.each(result,
                function(key, value) {
                    $tourTypeId.append("<option value='" + key + "'>" + value + "</option>");
                });
            });
        }
    }
