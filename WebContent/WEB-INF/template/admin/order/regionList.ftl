								...
								<div class="nav-panel">
									...
									<div class="nav-block">
										...
										<div class="block-body default-2-line">
											<div class="params-cont"> 
												<input type="text" size="14" id="search_orderNumber" placeholder="Order No..." />
												<input type="text" size="14" id="search_totalPeople" placeholder="Total People..." />
												<input type="text" size="14" id="search_company" placeholder="Company..." />
												<input type="text" size="14" id="search_contactName" placeholder="Contact Name..." />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/orders/regionList.jhtml'/]",
                type: "POST",
                "data": function ( d ) {
	                ...
	                d.customerSource = $("#search_customerSource").val();
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
						...
						+'<li><a href="edit.jhtml?menuId=305&ordersTotalId='+data+'"><i class="fa fa-pencil"></i>Edit</a></li>'
		...
		$("#subId").on( 'click', function () {
        	...
        	//$("div.options").slideToggle("slow");
        	//$("#filter").removeClass("fa fa-caret-square-o-up fa-lg color-blue").addClass("fa fa-caret-square-o-down fa-lg color-blue");
    	});
    });
