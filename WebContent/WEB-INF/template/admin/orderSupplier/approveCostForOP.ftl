			...
			<div class="col-md-12">
						<div class="tab-container">
							<ul class="nav nav-tabs">
							  ...
							  <li class="active"><a href="javascript:;" onclick="javascript:window.location.href='approveCostForOP.jhtml'" data-toggle="tab">Cost</a></li>
...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary">
    <div class="md-content">
      ...
      <form id="verifyFormId" action="approveCostPassForOP.jhtml" style="border-radius: 0px;" method="post">
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/approveCostForOP.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
