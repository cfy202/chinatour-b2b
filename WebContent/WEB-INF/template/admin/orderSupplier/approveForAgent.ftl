                ...
                <div class="col-md-12">
                    <div class="tab-container">
							<ul class="nav nav-tabs">
							  <li><a href="javascript:;" onclick="javascript:window.location.href='agentTourList.jhtml'" data-toggle="tab">Common Tour</a></li>
							  <li  class="active"><a href="javascript:;" onclick="javascript:window.location.href='approveForAgent.jhtml'" data-toggle="tab">Europe Tour&nbsp;&nbsp;&nbsp;<span class="bubble">${sumForAgent}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
							  <li><a href="javascript:;" onclick="javascript:window.location.href='approveRevisedForAgent.jhtml'" data-toggle="tab">Revised Bill(Europe Tour)</a></li>
							</ul>
                        </div>
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/approveForAgent.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
