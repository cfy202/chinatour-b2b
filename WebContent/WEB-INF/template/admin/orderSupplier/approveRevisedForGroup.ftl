			...
			<div class="col-md-12">
						<div class="tab-container">
							<ul class="nav nav-tabs">
							  ...
							  <li><a href="javascript:;" onclick="javascript:window.location.href='approveForGroup.jhtml'" data-toggle="tab">Europe Tour&nbsp;&nbsp;&nbsp;<span class="bubble">${sumForAgent}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
							  <li  class="active"><a href="javascript:;" onclick="javascript:window.location.href='approveRevisedForGroup.jhtml'" data-toggle="tab">Revised Bill(Europe Tour)</a></li>
							</ul>
                        </div>
...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary">
    <div class="md-content">
      ...
      <form id="verifyFormId" action="approveRevisedPassForAgent.jhtml" style="border-radius: 0px;" method="post">
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/approveRevisedForAgent.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
