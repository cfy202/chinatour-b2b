...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary" style=" width: 50%; max-height: 550px;">
	<div class="md-content">
		...
		<form action="${base}/admin/supplierPrice/update.jhtml" id="updateId" method="post">
		</form>
	</div>
</div>
<!--/修改弹出框-->
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/supplierPrice/orderInfoList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
            ...
            "columns": [
                ...
                { "data": "supplierPrice.supType" ,
                	...
                	"render": function (data, type, row) {
	              		var html="<a href='searchSupplier.jhtml?type=1&tourId="+row.tourId+"&tourCode="+row.tourCode+"' >";
                ...
                { "data": "supplierPrice.supType" ,
                	...
                	"render": function (data, type, row) {
                			var str=data
                			var html="<a href='searchSupplier.jhtml?type=2&tourId="+row.tourId+"&tourCode="+row.tourCode+"'>";
                ...
                { "data": "supplierPrice.supType" ,
                	"class": "text-center" ,
                	"render": function (data, type, row) {
	              		var html="<a href='searchSupplier.jhtml?type=3&tourId="+row.tourId+"&tourCode="+row.tourCode+"'>";
                ...
                { "data": "supplierPrice.supType" ,
                	"class": "text-center" ,
                	"render": function (data, type, row) {
	              		var html="<a href='searchSupplier.jhtml?type=4&tourId="+row.tourId+"&tourCode="+row.tourCode+"'>";
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					...
					+'<li class="divider"></li><li><li><a style="cursor:pointer;" href="opTotalCheck.jhtml?tourId='+row.tourId+'&tourCode='+row.tourCode+'"><i class="fa fa-pencil"></i>Auditing Details</a></li>'
					+'<li><a style="cursor:pointer;" href="totalBillOfTour.jhtml?tourId='+row.tourId+'&tourCode='+row.tourCode+'"><i class="fa fa-pencil"></i>Bill</a></li>';
                 },
				"targets" : 11
		   }]
		   ,
		  "fnCreatedRow": function( nRow, aData, iDataIndex ) {
		    	...
		    	if(aData.supplierPrice.supplierPriceId!=null&&aData.supplierPrice.supplierPriceId.length>0){
		    		str+='<a data-href="${base}/admin/supplierPrice/uploadTourFile?supplierPriceId='+aData.supplierPrice.supplierPriceId+'" style="cursor: pointer;"  data-toggle="modal"  data-target="#confirm-upload"><i class="fa fa-upload"></i></a>';
		    	}else{
