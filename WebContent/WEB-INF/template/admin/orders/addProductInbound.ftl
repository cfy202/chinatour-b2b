                ...
                <div class="col-md-12">
                    <div class="block-flat">
						<ul class="nav nav-tabs">
							...
							<li class="active"><a data-toggle="tab">inbound</a></li>
						</ul>
				...
				<table style="padding:10px;border: 0px none" width="100%">
					<tbody>
						...
						<tr>
							...
							<td>
								<input class="form-control" name="brand" value="inbound" readOnly="readOnly" type="text">
							</td>
						</tr>
						<tr>
							<td>
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "bFilter":false,
            "ajax": {
                url: "[@spring.url '/admin/orders/groupLineList.jhtml?brand=inbound&isSystem=1'/]",
                type: "POST",
                "data": function ( d ) {
            ...
            "columnDefs" : [{
				"render" : function(data, type, row) {
					return '<a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=inbound&groupLineId='+ data +'">book</a>';
                 },
				"targets" : 3
		   }]
		});
    ...
    function saveIndependentProduct(){
		$.ajax({
			...
			success:function(groupLineId){
				...
				$tds.eq(2).html("inbound");
				$tds.eq(3).html($("#tripDescInput").val());
				$tds.eq(4).html('<a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=inbound&groupLineId='+ groupLineId +'">booking</a>');
