                ...
                <div class="col-md-12">
                    <div class="block-flat">
						<ul class="nav nav-tabs">
							...
							<li class="active"><a data-toggle="tab">文景假期</a></li>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" style="display:none" id="otherTable">
							        <thead>
							            ...
							            <tr>
							                <th>Flight</th>
							                <th><a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=文景假期&singleType=flight">book</a></th>
							            </tr>
							            <tr>
							                <th>Hotel</th>
							                <th><a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=文景假期&singleType=hotel">book</a></th>
							            </tr>
							            <tr>
							                <th>Cruise</th>
							                <th><a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=文景假期&singleType=cruise">book</a></th>
							            </tr>
							        </thead>
							    </table>
                            </div>
				...
				<table style="padding:10px;border: 0px none" width="100%">
					<tbody>
						...
						<tr>
							...
							<td>
								<input class="form-control" name="brand" value="文景假期" readOnly="readOnly" type="text">
							</td>
						</tr>
						<tr>
							<td>
...
<script type="text/javascript">
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "bFilter":false,
            "ajax": {
                url: "[@spring.url '/admin/orders/groupLineList.jhtml?brand=文景假期&isSystem=1'/]",
                type: "POST",
                "data": function ( d ) {
            ...
            "columnDefs" : [{
				"render" : function(data, type, row) {
					return '<a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=文景假期&groupLineId='+ data +'">book</a>';
                 },
				"targets" : 3
		   }]
		});
    ...
    function changeOperater(operater){
    	...
    	if($option.attr("value") == 'other'){
    		...
    		$("#indeTable").hide();
    		$("#sourceSelect").empty();
    		$.post('venderList.jhtml',{'brand':'文景假期','operater':$option.attr("value")},function(map){
    			var html='';
    ...
    function saveIndependentProduct(){
		$.ajax({
			...
			success:function(groupLineId){
				...
				$tds.eq(4).html('<a href="bookProduct.jhtml?ordersTotalId=${ordersTotalId}&brand=文景假期&groupLineId='+ groupLineId +'">booking</a>');
