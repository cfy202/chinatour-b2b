      ...
      <div class="col-md-12 fuelux">
        ...
        <div class="block-wizard">
          ...
          <div class="step-content">
            <form class="form-horizontal group-border-dashed" action="addProductNew.jhtml" method="post" data-parsley-validate novalidate> 
				<input type="hidden" name="ordersTotalId" value="${ordersTotalId}">
				<input type="hidden" id="other" value="${groupLine.tourNameEn}">
				[#-- groupline存在，则非单订     --]
				[#if groupLine??]
						...
						<table style="word-break:break-all;white-space:nowrap;border: 0px none" width="100%">
							<tbody>
								...
								<tr>
									...
									<td width="37%"> 
										[#if groupLine.tourNameEn=="OtherBooking"]
												<input id="scheduleOfArriveTimeInput" type="text" name="tourInfoForOrder.scheduleOfArriveTime" class="form-control input-group1"  placeholder="yyyy-mm-dd"/>
										[#else]
								...
								<tr>
									...
									<td width="37%">
										<textarea name="tourInfoForOrder.InvoiceRemarks" cols="30" rows="8" class="form-control input-group"></textarea>
									</td>
								</tr>
