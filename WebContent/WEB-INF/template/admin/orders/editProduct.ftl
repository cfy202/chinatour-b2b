        ...
        <div class="page-head">
           <h2>
            ...
            <div class="new" style="width:300px">
            	<button id="PrePosthotel" type="button" data-modal="PrePost" class="btn btn-success btn-flat md-trigger">Hotel</button>
      ...
      <div class="block-flat">
        ...
        <div class="block-wizard">
          ...
          <div class="step-content">
            <form id="form" class="form-horizontal group-border-dashed" action="tourOrderUpdate.jhtml" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate> 
							...
							<tbody>
								...
								<tr>
									...
									<td width="37%"> 
										...
										<input class="form-control input-group1 JDATE" type="text" name="tourInfoForOrder.scheduleOfArriveTime" value="[#if (productVO.tourInfoForOrder.scheduleOfArriveTime)??]${productVO.tourInfoForOrder.scheduleOfArriveTime?string('yyyy-MM-dd')}[/#if]" class="form-control input-group1" required  placeholder="yyyy-mm-dd" />
										<font size="3px" color="red">
										    &nbsp;*
										</font>
									</td>
									...
									<td width="37%">
										<input type="text" name="tourInfoForOrder.specialRequirements" value="${productVO.tourInfoForOrder.specialRequirements}" class="form-control input-group1"/>
								...
								<tr>
									...
									<td width="37%"> 
										<input class="form-control input-group1 JDATE" type="text" name="tourInfoForOrder.dueDate" value="[#if (productVO.tourInfoForOrder.dueDate)??]${productVO.tourInfoForOrder.dueDate?string('yyyy-MM-dd')}[/#if]" class="form-control input-group1"  placeholder="yyyy-mm-dd" />
										<font size="2px" color="red">
										    &nbsp;*
										</font>
									</td>
						...
						<tbody id="feeTbody">
							<tr class="commonTourFee">
								...
								<td width="40%" colspan="2">
									<input class="form-control input-group1" style="width:100%" name="adultItem.remark" type="text" value="${productVO.adultItem.remark}">
								</td>
							...
							<tr class="commonTourFee">
								...
								<td colspan="2">
									<input class="form-control input-group1" style="width:100%" name="childrenItem.remark" type="text" value="${productVO.childrenItem.remark}">
								</td>
								...
								<td 20%>
									...
									<select type="text" id="optionals" name="otherFeeList[feeIndex].optionalId" style="width:300px;" onchange="optional(this);" class="select2">
											...
											[#list optionalist as optional]
												<option value="${optional.id}" [#if "${optional.name==otherFee.remark}"] selected="selected" [/#if] >${optional.name}</option>
											[/#list]
									</select>
							...
							[#list orderFeeItemsList as orderFeeItems]
								[#if orderFeeItems.num==10]
									...
									<input type="hidden" name="orderFeeItems[${orderFeeItems.num-1}].feeTitle" value="${orderFeeItems.feeTitle}">
									<tr class="3">
					...
					<table style="word-break:break-all;white-space:nowrap;border: 0px none;display:none;" width="100%" id="b2bFeeTable">
						...
						<tbody >
						 <!-- [#list orderFeeItemsList as orderFeeItems]
						  ...
						  [/#list]-->
							[#list orderFeeItemsList as orderFeeItems]
						  	[#if orderFeeItems.num!=10 && orderFeeItems.num!=11]
								<tr id="${orderFeeItems.id}">
									<input type="hidden" name="orderFeeItems[${orderFeeItems.num-1}].id" value="${orderFeeItems.id}">
									<td><input type="text" name="orderFeeItems[${orderFeeItems.num-1}].feeTitle" value="${orderFeeItems.feeTitle}"  class="form-control input-group1">:</td>
									<td><input type="text" name="orderFeeItems[${orderFeeItems.num-1}].price" value="${orderFeeItems.price}" class="form-control input-group1"></td>
									<td>Qty: </td>
									<td><input type="text" name="orderFeeItems[${orderFeeItems.num-1}].pax" value="${orderFeeItems.pax}" class="form-control input-group1">&nbsp; &nbsp;<a style="cursor:pointer;" class="fa fa-minus" onclick="deleteItemFee('${orderFeeItems.id}');"></td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
							[/#if]
							[#if !orderFeeItems_has_next]<input type="hidden" value="${orderFeeItems.num}" id="b2bFeeNum"/>[/#if]
						  [/#list]
						  <tr class="3" id="abpDiv">
								<td colspan="5">
									<a href="javascript:;" onClick="addSubFee()">Add B2B Price</a>
								</td>
							</tr>
						</tbody>
					</table>
...
<!--放在此处为了触发该事件时，将其他的页面覆盖-->
<div class="md-modal colored-header custom-width md-effect-9" id="PrePost" style="width:80%;">
			    <div class="md-content" >
			      <div class="modal-header">
			      	<h3>Pre/Post Hotel</h3>
			        <button type="button" class="close md-close" data-dismiss="modal" aria-hidden="true">&times;</button>
			      </div>
					              ...
					              <thead>
					                  <tr>
					                       ...
					                       <th width="12%">Type</th>
													...
													[#list prePostHotel as hotels]
													<tr>
														<td>${hotels.guest} </td>
														<td>${hotels.roomType} </td>
														<td>${hotels.roomNo}</td>
														<td>${hotels.nights}</td>
														<td>[#if hotels.type==0]Pre Hotel[#elseif hotels.type==1]Post Hotel[#else][/#if]</td>
													</tr>
													[/#list]
												</tbody>
					          </table>
				...
				<tbody>
					...
					<tr>
						...
						<td width="60%"  class="text-left">
							<label class="radio-inline">
								<div class="iradio_square-blue" style="position: relative;" aria-checked="false" aria-disabled="false">
									<input class="icheck" type="radio" name="newState" value="1" checked=""
										style="position: absolute; opacity: 0;">
										<ins class="iCheck-helper"
											style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;">
										</ins>
							...
							<label class="radio-inline">
								<div class="iradio_square-blue" style="position: relative;" aria-checked="false" aria-disabled="false">
									<input class="icheck" type="radio" name="newState" value="0"
										style="position: absolute; opacity: 0;">
										<ins class="iCheck-helper"
											style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;">
										</ins>
...
<script type="text/javascript">
    ...
    function updateOrder(){
    	...
    	var updateRemark = $("#remark").val();
    	var newState = $recordForm.find("input[name='newState']:checked").val();
    	if(newState=='1' && $.trim(updateRemark)==''){
    		alert('Modify Record cannot be null.');
    	}else{
    		$("#updateRemark").val(updateRemark);
    ...
    /**增加额外费用详情**/
    function addSubFee(type,num){
       	var num=$("#b2bFeeNum").val();
       	var nnum=Number(num)+1;
       	var html='<tr id="tr'+num+'"><input type="hidden" name="orderFeeItems['+num+'].id"><input type="hidden" name="orderFeeItems['+num+'].num" value="'+nnum+'">'
			+'<td><input type="text" name="orderFeeItems['+num+'].feeTitle" class="form-control input-group1">:</td>'
			+'<td><input type="text" name="orderFeeItems['+num+'].price" class="form-control input-group1"></td>'
			+'<td>Qty: </td>'
			+'<td><input type="text" name="orderFeeItems['+num+'].pax"  class="form-control input-group1">'
			+'&nbsp;&nbsp;<a style="cursor:pointer;" class="fa fa-minus" onclick="deltr('+num+')"></td>'
			+'<td >&nbsp;</td>'
			+'<td >&nbsp;</td>'
			+'</tr>';
			$("#abpDiv").before(html);
    ...
    function deleteItemFee(x){
    	var ItemData=x;
    	$.ajax({
            type: "POST",
            url:"deleteItemFee.jhtml",
            data:{ Id:ItemData },
