	...
	<div class="row">
      <div class="col-md-12">
        ...
        <div class="block-flat">
          <div class="content">
              <form class="form-horizontal group-border-dashed" id="formId" method="POST"   action="${base}/admin/roomSharing/save.jhtml" parsley-validate novalidate>
              <input type="hidden" name="roomOrTour" value="${roomSharing.roomOrTour}" />
              <div class="form-group">
                <label class="col-sm-3 control-label">Product Code</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control"  name="productCode" required placeholder="Please enter the Tour Code" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control"  name="productName" required placeholder="Please enter the Product Name" />
                </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control"  name="totalPeople" parsley-type="number"/>
                </div>
              </div>
                 [/#if]
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
	                    ...
	                    <input  name="arrivalDate" class="form-control" size="16" type="text" value="" readonly>
               ...
               <div class="col-sm-6">
				<select id="selCountry" name="tourType" required class="select2" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
				<select id="selCountry" name="roomType" required class="select2" >
					<option value="">Select</option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <label class="radio-inline"> <input type="radio" name="Status" value="0" checked="" class="icheck"> Pending</label> 
                  <label class="radio-inline"> <input type="radio" name="Status" value="1" class="icheck"> Closed</label> 
                </div>
              </div>
