	...
	<div class="row">
      <div class="col-md-12">
        ...
        <div class="block-flat">
          ...
          <div class="content">
              <form class="form-horizontal group-border-dashed" id="formId" method="POST"   action="${base}/admin/shareSpace/save.jhtml">
             
              <div class="form-group">
                <label class="col-sm-3 control-label">Folder Name</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control"  name="typeName"  placeholder="Please enter the File Name" />
                </div>
              </div>
