	                                    ...
	                                    <thead>
	                                	 ...
	                                	 [#list statisticalList as st]
		                                   ...
		                                   [#list st.flightList as flight]
		                                   	<tr>
		                                        <td><a href="javascript:;" onclick="viewInfor('${flight.agency}','${flight.deptId}')">${flight.venderName}</a></td>
...
<script type="text/javascript">
    ...
    function bookingPeer(a,b){
    	location.href="${base}/admin/statistical/agencyStatistical.jhtml?time="+b;
    }
    function bookingPeerYear(){
		var role=$("#role").val();
    	var year=$("#year").val();
    	var time=$("#time").val();
    	location.href="${base}/admin/statistical/agencyStatistical.jhtml?year="+year;
    }
    function sear() {
			var role=$("#role").val();
        	var year=$("#year").val();
        	...
        	if(time.indexOf('-')<0){
        		location.href="${base}/admin/statistical/agencyStatistical.jhtml?year="+time+"&deptId="+deptId;
        	}else{
    			location.href="${base}/admin/statistical/agencyStatistical.jhtml?time="+time+"&deptId="+deptId;
    			}
		}
		...
		function viewInfor(a){
        	...
        	var agency=a;
        	if(time.indexOf('-')<0){
    			location.href="${base}/admin/statistical/ticketList.jhtml?year="+time+"&agency="+agency;
    		}else{
    			location.href="${base}/admin/statistical/ticketList.jhtml?time="+time+"&agency="+agency;
    		}
		}
		//获取两位小数点
