			...
			<div class="col-md-12">
			 <div class="block-flat">
						...
						<div class="tab-content">
							...
							<input type="hidden" id="valSize" value="${statisticalList?size}">
								...
								<div id="" class="content">
									<table id="dataTable2" class="ompTable">
										...
										<tbody class="no-border">
											...
											<tr>
												<td>${acc.brand}</td>
												<td id="jan"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-01')">${acc.jan}</a></td>
												<td id="feb"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-02')">${acc.feb}</td>
												<td id="mar"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-03')">${acc.mar}</td>
												<td id="apr"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-04')">${acc.apr}</td>
												<td id="may"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-05')">${acc.may}</td>
												<td id="jun"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-06')">${acc.jun}</td>
												<td id="jul"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-07')">${acc.jul}</td>
												<td id="aug"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-08')">${acc.aug}</td>
												<td id="sep"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-09')">${acc.sep}</td>
												<td id="oct"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-10')">${acc.oct}</td>
												<td id="nov"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-11')">${acc.nov}</td>
												<td id="dec"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}-12')">${acc.dec}</td>
												<td id="total"><a href="javascript:;" onclick="viewInfor('${acc.brand}','${statistical.time}')">${acc.total}</td>
...
<script type="text/javascript">
    ...
    function sear(){
    	var role=$("#role").val();
    		...
    		location.href="${base}/admin/statistical/arrivalForBrand.jhtml?role="+role+"&menuId="+menuId+"&time="+year+"&deptId="+deptId;
    }
    ...
    //查看详情
		function viewInfor(a,b){
        	...
        	if(b.indexOf('-')<0){
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&year="+b+"&deptId="+deptId+"&brand="+a+"&userId="+userId;
    		}else{
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&time="+b+"&deptId="+deptId+"&brand="+a+"&userId="+userId;
    		}
		}
    //获取两位小数点
