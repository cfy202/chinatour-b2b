...
<script type="text/javascript">
    $(document).ready(function () {
     ...
     function sear(){
    		...
    		location.href="${base}/admin/statistical/arrivalForDept.jhtml?role="+role+"&menuId="+menuId+"&time="+year+"&isSelfOrganize="+isSelfOrganize;
		}
		 //查看详情
		function viewInfor(a,b){
        	...
        	if(b.indexOf('-')<0){
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&year="+b+"&deptId="+a+"&isSelfOrganize="+isSelfOrganize+"&orderType="+orderType;
    		}else{
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&time="+b+"&deptId="+a+"&isSelfOrganize="+isSelfOrganize+"&orderType="+orderType;
    		}
		}
		//获取两位小数点
