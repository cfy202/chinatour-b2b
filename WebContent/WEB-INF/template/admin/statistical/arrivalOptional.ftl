...
<script type="text/javascript">
   ...
   function sear() {
		...
		function viewInfor(a){
        	...
        	if(time.indexOf('-')<0){
    			location.href="${base}/admin/statistical/orderDetailsOptional.jhtml?role="+role+"&menuId="+menuId+"&year="+time+"&deptId="+deptId+"&optionalId="+a+"&wr="+wr+"&brand="+brand+"&userId="+userId;
    		}else{
    			location.href="${base}/admin/statistical/orderDetailsOptional.jhtml?role="+role+"&menuId="+menuId+"&time="+time+"&deptId="+deptId+"&optionalId="+a+"&wr="+wr+"&brand="+brand+"&userId="+userId;
    		}
		}
	//获取两位小数点
