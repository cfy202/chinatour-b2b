...
<script type="text/javascript">
    ...
    function bookingPeer(a,b){
    	...
    	if(time.indexOf('-')<0){
        	location.href="${base}/admin/statistical/arrivalForPeer.jhtml?role="+role+"&menuId="+menuId+"&year="+time+"&peerType="+peerType+"&deptId="+deptId+"&venderId="+venderId;
    	}else{
			location.href="${base}/admin/statistical/arrivalForPeer.jhtml?role="+role+"&menuId="+menuId+"&time="+time+"&peerType="+peerType+"&deptId="+deptId+"&venderId="+venderId;
		}
    }
    function bookingPeerYear(){
    	...
    	var venderId=$("#userSelect").val();
    	var menuId=$("#menuId").val();
        location.href="${base}/admin/statistical/arrivalForPeer.jhtml?role="+role+"&menuId="+menuId+"&year="+year+"&peerType="+peerType+"&deptId="+deptId+"&venderId="+venderId;
    }
    function sear() {
			var role=$("#role").val();
        	var year=$("#year").val();
		...
		function viewInfor(a,b){
        	...
        	if(time.indexOf('-')<0){
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&year="+time+"&deptId="+deptId+"&peerId="+a+"&orderType="+orderType+"&peerType="+peerType+"&userId="+userId;
    		}else{
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&time="+time+"&deptId="+deptId+"&peerId="+a+"&orderType="+orderType+"&peerType="+peerType+"&userId="+userId;
    		}
		}
		//获取两位小数点
