...
<script type="text/javascript">
    $(document).ready(function () {
     ...
     function sear() {
    		...
    		location.href="${base}/admin/statistical/bookingForBrand.jhtml?role="+role+"&menuId="+menuId+"&time="+year+"&deptId="+deptId;
		}
		//查看详情
		function viewInfor(a,b){
        	...
        	if(b.indexOf('-')<0){
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&year="+b+"&deptId="+deptId+"&brand="+a+"&ticketType=booking&userId="+userId;
    		}else{
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&time="+b+"&deptId="+deptId+"&brand="+a+"&ticketType=booking&userId="+userId;
    		}
		}
	//获取两位小数点
