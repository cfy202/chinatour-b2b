...
<script type="text/javascript">
    ...
    function bookingPeer(a,b){
    	...
    	location.href="${base}/admin/statistical/financialStatistical.jhtml?role="+a+"&menuId="+menuId+"&time="+b;
    }
    function bookingPeerYear(){
    	...
    	var time=$("#time").val();
    	var menuId=$("#menuId").val();
    	location.href="${base}/admin/statistical/financialStatistical.jhtml?role="+role+"&menuId="+menuId+"&year="+year;
    }
    function sear() {
			var role=$("#role").val();
        	var year=$("#year").val();
        	...
        	if(time.indexOf('-')<0){
        		location.href="${base}/admin/statistical/financialStatistical.jhtml?role="+role+"&menuId="+menuId+"&year="+time+"&deptId="+deptId+"&userName="+userName+"&orderType="+orderType;
        	}else{
    			location.href="${base}/admin/statistical/financialStatistical.jhtml?role="+role+"&menuId="+menuId+"&time="+time+"&deptId="+deptId+"&userName="+userName+"&orderType="+orderType;
    			}
		}
		//查看详情
		function viewInfor(a){
        	...
        	var orderType=$("#orderType").val();
        	if(time.indexOf('-')<0){
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&year="+time+"&deptId="+deptId+"&userId="+a+"&orderType="+orderType;
    		}else{
    			location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&menuId="+menuId+"&time="+time+"&deptId="+deptId+"&userId="+a+"&orderType="+orderType;
    		}
		}
