...
<script type="text/javascript">
    ...
    function bookingPeer(a,b){
    	...
    	location.href="${base}/admin/statistical/peerBookBStatistical.jhtml?role="+a+"&menuId="+menuId+"&time="+b;
    }
    function bookingPeerYear(){
    	...
    	var time=$("#time").val();
    	var menuId=$("#menuId").val();
    	location.href="${base}/admin/statistical/peerBookBStatistical.jhtml?role="+role+"&menuId="+menuId+"&year="+year;
    }
    function sear() {
			var role=$("#role").val();
        	var year=$("#year").val();
        	...
        	if(time.indexOf('-')<0){
        		location.href="${base}/admin/statistical/peerBookBStatistical.jhtml?role="+role+"&menuId="+menuId+"&year="+time+"&deptId="+deptId+"&userName="+userName+"&isSelfOrganize="+isSelfOrganize;
        	}else{
    			location.href="${base}/admin/statistical/peerBookBStatistical.jhtml?role="+role+"&menuId="+menuId+"&time="+time+"&deptId="+deptId+"&userName="+userName+"&isSelfOrganize="+isSelfOrganize;
    			}
		}
		//查看详情
