	                                ...
	                                <table class="table table-bordered" id="datatable2">
	                                   ...
	                                   [#list statisticalList as st]
		                                   ...
		                                   [#list st.flightList as flight]
		                                   	<tr>
		                                        <td><a href="javascript:;" onclick="viewInfor('${flight.agentId}','${flight.tempValue01}')">${flight.tempValue01}</a></td>
...
<script type="text/javascript">
    ...
    function bookingPeer(a,b){
    	location.href="${base}/admin/statistical/retailStatistical.jhtml?time="+b;
    }
    function bookingPeerYear(){
		var role=$("#role").val();
    	var year=$("#year").val();
    	var time=$("#time").val();
    	location.href="${base}/admin/statistical/retailStatistical.jhtml?year="+year;
    }
    function sear() {
			var role=$("#role").val();
        	var year=$("#year").val();
        	...
        	if(time.indexOf('-')<0){
        		location.href="${base}/admin/statistical/retailStatistical.jhtml?year="+time+"&deptId="+deptId;
        	}else{
    			location.href="${base}/admin/statistical/retailStatistical.jhtml?time="+time+"&deptId="+deptId;
    			}
		}
		...
		function viewInfor(a,b){
        	...
        	var agentId=a;
        	if(time.indexOf('-')<0){
    			location.href="${base}/admin/statistical/ticketList.jhtml?year="+time+"&tempValue01="+tempValue01+"&agentId="+agentId;
    		}else{
    			location.href="${base}/admin/statistical/ticketList.jhtml?time="+time+"&tempValue01="+tempValue01+"&agentId="+agentId;
    		}
		}
		//获取两位小数点
