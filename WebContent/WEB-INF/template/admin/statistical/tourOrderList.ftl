                ...
                <div class="col-md-12">
                    <div class="block-flat">
                        <div class="header" style="font-family:'Arial';font-size:16px;font-weight:bold;">
							...
							<input type="hidden" id="groupLineId" value="${order.groupLineId}"/>
...
<script type="text/javascript">
	...
	function formatAsText(item){
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/statistical/orderDetails.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
	                data.time = $("#time").val();
	                data.year = $("#year").val();
	                ...
	                data.groupLineId = $("#groupLineId").val();
    ...
    function search(){
        ...
        var role = $("#role").val();
        if(time.indexOf("-")<0){
        	location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&orderType="+orderType+"&year="+year+"&deptId="+deptId+"&groupLineId="+groupLineId+"&isSelfOrganize="+isSelfOrganize+"&userId="+userId+"&userName="+userName+"&peerId="+peerId+"&brand="+brand+"&wr="+wr+"&ticketType="+ticketType;
        }else{
        	location.href="${base}/admin/statistical/orderDetailsPage.jhtml?role="+role+"&orderType="+orderType+"&time="+time+"&deptId="+deptId+"&groupLineId="+groupLineId+"&isSelfOrganize="+isSelfOrganize+"&userId="+userId+"&userName="+userName+"&peerId="+peerId+"&brand="+brand+"&wr="+wr+"&ticketType="+ticketType;
        }
    }
    function printOrder(){
		var time = $("#time").val();
        ...
        var role = $("#role").val();
        if(time.indexOf("-")<0){
        	location.href="${base}/admin/statistical/orderDetailsPrint.jhtml?role="+role+"&orderType="+orderType+"&year="+year+"&deptId="+deptId+"&groupLineId="+groupLineId+"&isSelfOrganize="+isSelfOrganize+"&userId="+userId+"&userName="+userName+"&peerId="+peerId+"&brand="+brand+"&wr="+wr+"&ticketType="+ticketType;
        }else{
        	location.href="${base}/admin/statistical/orderDetailsPrint.jhtml?role="+role+"&orderType="+orderType+"&time="+time+"&deptId="+deptId+"&groupLineId="+groupLineId+"&isSelfOrganize="+isSelfOrganize+"&userId="+userId+"&userName="+userName+"&peerId="+peerId+"&brand="+brand+"&wr="+wr+"&ticketType="+ticketType;
        }
    }
	function explorBill(){
		var time = $("#time").val();
        ...
        var role = $("#role").val();
        if(time.indexOf("-")<0){
        	location.href="${base}/admin/statistical/ExcelForStatistics.jhtml?role="+role+"&orderType="+orderType+"&year="+year+"&deptId="+deptId+"&groupLineId="+groupLineId+"&isSelfOrganize="+isSelfOrganize+"&userId="+userId+"&userName="+userName+"&peerId="+peerId+"&brand="+brand+"&wr="+wr+"&ticketType="+ticketType;
        }else{
        	location.href="${base}/admin/statistical/ExcelForStatistics.jhtml?role="+role+"&orderType="+orderType+"&time="+time+"&deptId="+deptId+"&groupLineId="+groupLineId+"&isSelfOrganize="+isSelfOrganize+"&userId="+userId+"&userName="+userName+"&peerId="+peerId+"&brand="+brand+"&wr="+wr+"&ticketType="+ticketType;
        }
	}
</script>
</body>
