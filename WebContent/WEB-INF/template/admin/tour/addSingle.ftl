        ...
        <div class="block-flat">
          ...
          <div class="content">
             <form class="form-horizontal group-border-dashed" id="formId" action="addOrders.jhtml" method="post" parsley-validate novalidate>     
		      ...
		      <input type="hidden" name="type" value="${order.tourTypeId}">
		      <input type="hidden" name="tourType" id="tourType" class="form-control" value="2">
			  <div class="form-group">
...
<script type="text/javascript">
    ...
    function chooseType(val){
    	...
    	$("#tourCodeT").select2({
			...
			ajax:{
				url:'[@spring.url '/admin/tour/listSelectForSingle.jhtml'/]',	//地址
			...
			initSelection: function(element, callback) {
		    	var id = $(element).val();
			    if (id !== "") {
				    $.ajax("[@spring.url '/admin/tour/listSelectForSingle.jhtml?id='/]" + id, {
				    	dataType: "json",
				    	type: "POST"
				    	}).done(function(data) { 
