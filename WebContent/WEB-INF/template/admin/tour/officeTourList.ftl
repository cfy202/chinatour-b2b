                ...
                <div class="col-md-12">
                	<div class="tab-container">
						<ul class="nav nav-tabs">
						  ...
						  <li><a href="javascript:;" onclick="javascript:window.location.href='officeTourList.jhtml?isChanged=2'" data-toggle="tab">&nbsp;&nbsp;&nbsp;&nbsp;Departing&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						  <li class="active"><a href="javascript:;" onclick="javascript:window.location.href='officeTourList.jhtml?isChanged=1'" data-toggle="tab">&nbsp;&nbsp;&nbsp;&nbsp;Departed&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						</ul>
                    </div>
										...
										<div  class="nav-block">
											...
											<div  class="block-body default-2-line">
												<div  class="params-cont"> 
													...
													<input type="text" size="14" id="search_deptName" placeholder="Dept..." />
												</div>
											</div>
										</div>
									</div>
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/tour/officeTourList.jhtml?isChanged=1'/]",
                type: "POST",
                "data": function ( data ) {
            ...
            "columns": [
                { "data": "tourCode" ,
                   "render": function (data, type, row) {
	              		return "<a href='tourCustomerList.jhtml?menuId=407&tourId="+ row.tourId +"'>"+ data +"</a>";
                    }
                },
                { "data": "lineName" },
                { "data": "arriveDateTime" },
