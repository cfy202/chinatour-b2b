                ...
                <div class="col-md-12">
                	<div class="tab-container">
						<ul class="nav nav-tabs">
						  ...
						  <li class="active"><a href="javascript:;" onclick="javascript:window.location.href='officeTourList.jhtml?isChanged=2'" data-toggle="tab">&nbsp;&nbsp;&nbsp;&nbsp;Departing&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						  <li><a href="javascript:;" onclick="javascript:window.location.href='officeTourList.jhtml?isChanged=1'" data-toggle="tab">&nbsp;&nbsp;&nbsp;&nbsp;Departed&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
						</ul>
                    </div>
    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/tour/officeTourList.jhtml?isChanged=2'/]",
                type: "POST",
                "data": function ( data ) {
