    ...
    $(document).ready(function () {
       ...
       $("#datatable2").attr("width","100%");
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/tour/tourAllList.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
            ...
            "columns": [
                { "data": "tourCode" ,
                   "render": function (data, type, row) {
	              		return "<a href='tourCustomerList.jhtml?menuId=402&tourId="+ row.tourId +"'>"+ data +"</a>";
                    }
                },
                { "data": "lineName" },
                { "data": "arriveDateTime" },
            ...
            "columnDefs" : [ {
				"render" : function(data, type, row) {
					return '<div class="btn-group"><button class="btn btn-default btn-xs" type="button">Action</button><button data-toggle="dropdown" class="btn btn-xs btn-primary dropdown-toggle" type="button"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button></div>';
                 },
				"targets" : 7
		  }],
